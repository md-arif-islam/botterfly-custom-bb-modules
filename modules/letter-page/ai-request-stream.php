...
if ( $letter ) {
    $prompt .= "The content of the letter should be: $letter. \n";
}

if ( $wnym ) {
    $prompt .= "The reason why I am writing the letter is: $wnym. \n";
}

if ( $cyt ) {
    $prompt .= "This letter is intended to convey: $cyt. ";
}

if ( $cc ) {
    $prompt .= "I should keep in mind that the recipient cares about: $cc. \n";
}

if ( $aoe ) {
    $prompt .= "The area of expertise required for this letter is: $aoe. \n";
}

if ( $pt ) {
    $prompt .= "The preferred tone for this letter is: $pt. \n";
}

if ( $pgas ) {
    $prompt .= "The recipient prefers the greeting as: $pgas. \n";
}
